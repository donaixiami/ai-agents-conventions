...
| **test-driven-development** | 实现功能、修 bug、重构、改行为之前；先写失败测试再写实现（TDD） | [`.grok/skills/test-driven-development/SKILL.md`](../.grok/skills/test-driven-development/SKILL.md) | [testing-anti-patterns](../.grok/skills/test-driven-development/testing-anti-patterns.md)、[来源](../.grok/skills/test-driven-development/SOURCE.md) |
...
| 写功能、修 bug、重构、TDD、先写测试、单元测试 | test-driven-development |
