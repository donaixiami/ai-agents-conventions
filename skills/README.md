...
| **uniapp-cross-platform** | uni-app 同时面向 App（Android/iOS）、微信小程序、H5 的新建、迁移、改造、审查与发布验收 | [`.grok/skills/uniapp-cross-platform/SKILL.md`](../.grok/skills/uniapp-cross-platform/SKILL.md) | [兼容矩阵](../.grok/skills/uniapp-cross-platform/references/compatibility-matrix.md)、[checklist](../.grok/skills/uniapp-cross-platform/references/checklist.md) |
...
| uni-app、App/Android/iOS、微信小程序、H5、跨端兼容、条件编译、真机验收 | uniapp-cross-platform |
...
- `uniapp-cross-platform` 的内容源是独立仓库 [`donaixiami/uniapp-cross-platform-skill`](https://github.com/donaixiami/uniapp-cross-platform-skill)，本仓通过 submodule 固定版本；业务仓按项目需要使用相同版本或自己的镜像
